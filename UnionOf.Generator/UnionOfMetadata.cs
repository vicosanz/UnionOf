...
namespace UnionOf.Generator
{
	...
	public record UnionOfMetadata(string Namespace, IReadOnlyList<string> Usings, string Name, string NameTyped, string FullName, string Modifiers, IReadOnlyList<string> Types)
	{
		/// <summary>
